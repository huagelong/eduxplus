...
use App\Bundle\AdminBundle\Service\Mall\BannerService;
...
class BannerController extends BaseAdminController
{
     ...
     */
     public function indexAction( Request $request,Grid $grid, BannerService $bannerService){
         ...
         return $this->render("@AdminBundle/mall/banner/index.html.twig", $data);
     }
    ...
    public function addAction(Form $form) {
        ...
        return $this->render("@AdminBundle/mall/banner/add.html.twig", $data);
    }
    ...
    public function editAction($id, Form $form, BannerService $bannerService) {
        ...
        $data = [];
        $data["formData"] = $formData;
        return $this->render("@AdminBundle/mall/banner/edit.html.twig", $data);
    }
    ...
    public function indexMainAction( $pid, Request $request,Grid $grid, BannerService $bannerService){
        ...
        return $this->render("@AdminBundle/mall/bannermain/index.html.twig", $data);
    }
    ...
    public function addMainAction($pid, Form $form) {
        ...
        $data["formData"] = $formData;
        $data["pid"] = $pid;
        return $this->render("@AdminBundle/mall/bannermain/add.html.twig", $data);
    }
    ...
    public function editMainAction($id, Form $form, BannerService $bannerService) {
        ...
        return $this->render("@AdminBundle/mall/bannermain/edit.html.twig", $data);
    }
