        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                previewSettings: {
                    ...
                    html: {width: '66px', height: '50px'},
                    text: {width: '66px', height: '50px'},
                    office: {width: '66px', height: '50px'},
                    gdocs: {width: '66px', height: '50px'},
                    video: {width: '66px', height: '50px'},
                    audio: {width: '100%', height: '30px'},
                    flash: {width: '66px', height: '50px'},
                    object: {width: '66px', height: '50px'},
                    pdf: {width: '100%', height: '50px', 'position': 'relative'},
                    other: {width: '66px', height: '50px'}
                },
                previewSettingsSmall: {
                    image: {width: 'auto', height: 'auto', 'max-width': '100%', 'max-height': '100%'},
                    html: {width: '100%', height: '50px'},
                    text: {width: '100%', height: '50px'},
                    office: {width: '100%', height: '50px'},
                    gdocs: {width: '100%', height: '50px'},
                    video: {width: '100%', height: 'auto'},
                    audio: {width: '100%', height: '30px'},
                    flash: {width: '100%', height: 'auto'},
                    object: {width: '100%', height: 'auto'},
                    pdf: {width: '100%', height: '50px'},
                    other: {width: '100%', height: '50px'}
                },
                previewZoomSettings: {
                    image: {width: 'auto', height: 'auto', 'max-width': '100%', 'max-height': '100%'},
                    html: vDefaultDim,
