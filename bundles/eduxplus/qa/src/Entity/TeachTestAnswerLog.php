 ...
 *
 * @ORM\Table(name="teach_test_answer_log", indexes={@ORM\Index(name="qa_node_id_idx", columns={"qa_node_id"}),@ORM\Index(name="uid_idx", columns={"uid"}),@ORM\Index(name="test_id_idx", columns={"test_id"})})
