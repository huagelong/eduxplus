...
use Eduxplus\EduxBundle\Entity\MallHelpCategory;

class HelpCategoryService extends AdminBaseService
{
    public function getCategoryTree($parentId)
    {
        $sql = "SELECT a FROM Edux:MallHelpCategory a WHERE a.parentId = :parentId ORDER BY a.sort ASC";
    ...
    {
        if (!$id) return "";
        $sql = "SELECT a.parentId FROM Edux:MallHelpCategory a WHERE a.id = :id";
    ...
    {
        $sql = "SELECT a FROM Edux:MallHelpCategory a WHERE a.parentId=:parentId";
    ...
    {
        $sql = "SELECT a FROM Edux:MallHelpCategory a WHERE a.id=:id";
    ...
    {
        $sql = "SELECT a FROM Edux:MallHelpCategory a ORDER BY a.sort ASC";
