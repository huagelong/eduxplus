...
class HelpService extends AdminBaseService
{
    ...
    public function getList($request, $page, $pageSize)
    {
        ...
        $dql = "SELECT a FROM Cms:CmsHelp a " . $sql . " ORDER BY a.id DESC";
    ...
    {
        $sql = "SELECT a FROM Cms:CmsHelp a WHERE a.id=:id";
    ...
    public function edit($id, $name, $content, $status, $categoryId, $sort, $topValue){
        ...
        $sql = "SELECT a FROM Cms:CmsHelpMain a WHERE a.helpId=:helpId";
