...
class PageController extends BaseAdminController
{
     ...
     */
     public function indexAction( Request $request,Grid $grid, PageService $pageService){
         ...
         return $this->render("@CoreBundle/mall/page/index.html.twig", $data);
     }
    ...
    public function addAction(Form $form) {
        ...
        return $this->render("@CoreBundle/mall/page/add.html.twig", $data);
    }
    ...
    public function viewAction($id, View $view, PageService $pageService) {
        ...
        $data = [];
        $data["formData"] = $formData;
        return $this->render("@CoreBundle/mall/page/view.html.twig", $data);
    }
    ...
    public function editAction($id, Form $form, PageService $pageService) {
        ...
        $data = [];
        $data["formData"] = $formData;
        return $this->render("@CoreBundle/mall/page/edit.html.twig", $data);
    }
