...
class GoodsController extends BaseAdminController
{
    ...
    public function indexAction(
       ...
       $grid->text("品类")->field("brand");
        ...
        return $this->render("@CoreBundle/mall/goods/index.html.twig", $data);
    }
    ...
    public function addAction(
        ...
        return $this->render("@CoreBundle/mall/goods/add.html.twig", $data);
    }
    ...
    public function addGroupAction(
        ...
        $data = [];
        $data["formData"] = $formData;
        return $this->render("@CoreBundle/mall/goods/addgroup.html.twig", $data);
    }
    ...
    public function editAction(
        ...
        $data = [];
        $data["formData"] = $formData;
        return $this->render("@CoreBundle/mall/goods/edit.html.twig", $data);
    }
    ...
    public function editgroupAction(
        ...
        $data = [];
        $data["formData"] = $formData;
        return $this->render("@CoreBundle/mall/goods/editgroup.html.twig", $data);
    }
    ...
    public function viewAction(
        ...
        $data = [];
        $data["formData"] = $formData;
        return $this->render("@CoreBundle/mall/goods/view.html.twig", $data);
    }
    ...
    public function viewgroupAction(
        ...
        $data = [];
        $data["formData"] = $formData;
        return $this->render("@CoreBundle/mall/goods/viewgroup.html.twig", $data);
    }
