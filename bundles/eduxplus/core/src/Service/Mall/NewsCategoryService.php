...
class NewsCategoryService extends AdminBaseService
{
    ...
    {
        $sql = "SELECT a FROM App:MallNewsCategory a WHERE a.parentId = :parentId ORDER BY a.sort ASC";
    ...
    {
        if (!$id) return "";
        $sql = "SELECT a.parentId FROM App:MallNewsCategory a WHERE a.id = :id";
    ...
    {
        $sql = "SELECT a FROM App:MallNewsCategory a WHERE a.parentId=:parentId";
    ...
    {
        $sql = "SELECT a FROM App:MallNewsCategory a WHERE a.id=:id";
    ...
    {
        $sql = "SELECT a FROM App:MallNewsCategory a ORDER BY a.sort ASC";
