...
use Eduxplus\CoreBundle\Entity\MallNewsCategory;

class NewsCategoryService extends AdminBaseService
{
    public function getCategoryTree($parentId)
    {
        $sql = "SELECT a FROM Core:MallNewsCategory a WHERE a.parentId = :parentId ORDER BY a.sort ASC";
    ...
    {
        if (!$id) return "";
        $sql = "SELECT a.parentId FROM Core:MallNewsCategory a WHERE a.id = :id";
    ...
    {
        $sql = "SELECT a FROM Core:MallNewsCategory a WHERE a.parentId=:parentId";
    ...
    {
        $sql = "SELECT a FROM Core:MallNewsCategory a WHERE a.id=:id";
    ...
    {
        $sql = "SELECT a FROM Core:MallNewsCategory a ORDER BY a.sort ASC";
